...
const DICTIONARY = {
  uz: {
    title: 'Yangiliklar',
    desc: 'Aeroportdagi barcha yangiliklar, tadbirlar va muhim eʼlonlar',
    all: 'Barchasi',
    post: 'yangilik',
    posts: 'yangiliklar',
  ...
  ru: {
    title: 'Новости',
    desc: 'Все новости, события и важные объявления аэропорта',
    all: 'Все',
    post: 'новость',
    posts: 'новости',
    showing: 'Показано:',
  ...
  en: {
    title: 'News',
    desc: 'All news, events, and important announcements at the airport',
    all: 'All',
    post: 'post',
    posts: 'posts',
    showing: 'Showing',
...
export default async function Page({
  ...
  const activeLocale = (
    locale && Object.keys(DICTIONARY).includes(locale) ? locale : 'uz'
    ...
    <div className="pt-24 pb-24 min-h-[80vh]">
      ...
      <div className="container mb-16 mt-8">
        <div className="max-w-4xl max-md:text-center animate-in fade-in slide-in-from-bottom-4 duration-700 bg-muted/30 p-8 md:p-12 rounded-md border border-border/50">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl max-md:mx-auto">{t.desc}</p>
        </div>
      </div>
